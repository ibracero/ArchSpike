...
object Dependencies {
    ...
    const val kodein_jvm = "org.kodein.di:kodein-di-generic-jvm:${Versions.kodein}"
    const val kodein_android = "org.kodein.di:kodein-di-framework-android-core:${Versions.kodein}"
